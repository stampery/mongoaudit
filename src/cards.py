...
class Cards(object):
    ...
    def display_overview(self, result):
        ...
        results_button = LineButton([('text', 'View detailed results')], vertical_padding=False)
        email_button = LineButton([('text', 'Email')], vertical_padding=False)
        export_button = LineButton([('text', 'Export')], vertical_padding=False)
        urwid.connect_signal(
